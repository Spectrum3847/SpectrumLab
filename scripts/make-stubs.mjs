...
const pages = [
  ...
  ['cnc/shopsabre-23', 'ShopSabre 23 CNC Router', 'Speeds and feeds, endmills, CAM setup, and spoilboard maintenance.'],
  ...
  ['3d-printing/large-format', 'Large-Format & Specialty Printers', 'Creality CR-6 Max, CR-10 Max, and Garolite setups.'],
  ['forming/langmuir-titan-25t', 'Langmuir Titan 25T Press Brake', 'Die selection, tonnage limits, backgauge programming, and safety.'],
  ['forming/box-pan-brake', 'Box & Pan Sheet Metal Brake', 'Manual brake setup, finger configuration, and bend technique.'],
